...
public class ApiMessagesResource {
    ...
    public ApiMessageResponse send(ApiMessage apiMessage) throws ApiException {
        try {
            ...
            else throw new ApiException(ex.getMessage());
        }
    }
     ...
     * @throws ApiException if an error occurs.
     */
    public ApiList<ApiMessage> get(Date start, Date end, int index, int limit, boolean pending, String direction) throws ApiException, Exception {
        boolean hasQ = false;
