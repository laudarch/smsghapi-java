...
public class ApiTicket {
	...
	private long rating;
	private List<ApiTicketResponse> responses;
	 ...
	 * 
	 */
	public ApiTicket(JsonObject json) {
		JsonValue val;
		this.responses = new ArrayList<ApiTicketResponse>();
		for (String name : json.names()) {
			...
			case "responses":
				for (JsonValue o : val.asArray()) {
					this.responses.add(new ApiTicketResponse(o.asObject()));
				}
				break;
			}
		}
...
/*	public void setSupportStatusId(long supportStatusId) {
	...
	public List<ApiTicketResponse> getResponses() {
		return responses;
	}
	...
	public String toJson(){
		...
		//json.add("SupportStatusId", this.supportStatusId);
